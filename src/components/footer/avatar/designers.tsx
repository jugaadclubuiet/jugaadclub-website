    ...
    <div className={styles.avatars}>
        <div className={styles.user}>
            <div className={styles.avatarsitem}>
                <Image src="/members/user.jpg" alt="Riya" width={200} height={200} className={styles.avatar} />
            </div>
        ...
        <div className={styles.user}>
            <div className={styles.avatarsitem}>
                <Image src="/members/user.jpg" alt="Karan" width={200} height={200} className={styles.avatar} />
            </div>
        ...
        <div className={styles.user}>
            <div className={styles.avatarsitem}>
                <Image src="/members/user.jpg" alt="Nancy"width={200} height={200} className={styles.avatar} />
            </div>
        ...
        <div className={styles.user}>
            <div className={styles.avatarsitem}>
                <Image src="/members/user.jpg" alt="Navya" width={200} height={200} className={styles.avatar}/>
            </div>
